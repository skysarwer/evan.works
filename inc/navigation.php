...
function evn_parent_menu_dropdown( $item_output, $item, $depth, $args ) {
    ...
    if ( ! empty( $item->classes ) && in_array( 'menu-item-has-children', $item->classes ) ) {
        ...
        return '<span class="flex">'.$item_output . '<button class="submenu-toggle outline" aria-expanded="false"  aria-label="'.$stripped_item_output.' sub-menu" aria-controls="submenu-'.$args->item_id.'">'.evn_caret_thick_svg().'</button></span>';
    }
